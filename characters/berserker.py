...
class Berserker(Character):
    ...
    def __init__(self, name):
        super().__init__(name,
                         health=BERSERKER_CONFIG['max_health'], attack_power=BERSERKER_CONFIG['attack_power'])
    ...
    def life_leech(self, opponent):
        ...
        self.health = min(self.max_health, self.health +
                          heal)  # Cap health at max_health
        print(f'{self.name} leeches {heal} health from {opponent.name}! Now at {self.health}/{self.max_health}!')
